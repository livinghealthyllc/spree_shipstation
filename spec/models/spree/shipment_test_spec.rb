...
describe Spree::Shipment do
  context "between" do
    before do
      ...
      # @shipment = create_shipment(updated_at: dt1)

      # @order1 = create(:order_no_validate, updated_at: dt1)
      # @shipment1 = create(:shipment_no_validate, updated_at: dt1)
      ...
      # @shipment1 = create(:shipment_no_validate, updated_at: dt1, order: create(:order_no_validate, updated_at: dt1))
      # @shipment1.order.updated_at = @order1.updated_at

      # @shipment1.order = @order1
      # @shipment1.order.updated_at = @dt1
      # @shipment1.save(validation:false)
      # @shipment1 = build(:shipment_with_order_dt, updated_at: dt1).save(validate: false) #
    end


    # expect(@shipment.updated_at).to eq(@dt1)
